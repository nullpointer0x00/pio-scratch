...
# shasum ${IBC_REFLECT_WASM}
# shasum ${REFLECT_WASM}
# shasum ${IBC_REFLECT_SEND_WASM} 
...
read -p "Send msgs"
${CHAIN1} tx wasm execute tp14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s96lrg8 '{"send_msgs":{"channel_id": "channel-1", "msgs":[{"bank":{"send":{"to_address": "tp13g9hxkljph90nt2waxtw3a40fkkz0dta3sgztv","amount":[{"denom": "nhash","amount": "420"}]}}}]}}' --amount 100nhash --from $VALIDATOR1 --fees 382000000nhash -y -o json | jq
